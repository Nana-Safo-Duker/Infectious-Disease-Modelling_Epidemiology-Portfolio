...
A comprehensive AI/ML epidemiology project focused on **Bayesian ML outbreak prediction**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** Bayesian ML outbreak prediction  
...
## Objectives
- Build a clear and reproducible analysis workflow for Bayesian ML outbreak prediction.
...
- **Left panel:** a simulated outbreak epidemic curve with observed daily case counts, the Bayesian posterior mean, and a 95% credible interval band — illustrating uncertainty-aware outbreak forecasting.
- **Right panel:** posterior distribution (histogram) of the estimated outbreak peak day, showing how Bayesian inference expresses uncertainty over a key epidemiological quantity.
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/337479441_A_Disease_Outbreak_Prediction_Model_Using_Bayesian_Inference_A_Case_of_Influenza
2. Add additional peer-reviewed references relevant to Bayesian ML outbreak prediction.
