...
A comprehensive AI/ML epidemiology project focused on **Deep learning vector diseases**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** Deep learning vector diseases  
**Primary paper/source:** To be added: include the primary peer-reviewed paper or technical report URL.

## Objectives
- Build a clear and reproducible analysis workflow for Deep learning vector diseases.
...
- **Left panel:** simulated training vs. validation loss curves over epochs for a vector-borne disease risk classifier.
- **Right panel:** a simulated ROC curve with AUC, illustrating discrimination performance reporting for a binary risk classifier.
...
## References
1. Primary paper/source: To be added: include the primary peer-reviewed paper or technical report URL.
2. Add additional peer-reviewed references relevant to Deep learning vector diseases.
