...
A comprehensive AI/ML epidemiology project focused on **Digital epidemiology ML**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** Digital epidemiology ML  
...
## Objectives
- Build a clear and reproducible analysis workflow for Digital epidemiology ML.
...
- **Left panel:** a simulated digital signal (e.g., search/social-media interest index) plotted alongside reported case counts over time on a dual axis.
- **Right panel:** a scatter plot with fitted trend line and correlation coefficient between the digital signal and reported cases, illustrating a nowcasting-style relationship.
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/381835344_Digital_Epidemiology_Harnessing_Big_Data_For_Early_Detection_And_Monitoring_Of_Viral_Outbreaks
2. Add additional peer-reviewed references relevant to Digital epidemiology ML.
