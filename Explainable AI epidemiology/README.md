...
- **Left panel:** a simulated SHAP-style feature importance bar chart for an outbreak-risk model.
- **Right panel:** a simulated partial-dependence curve showing how predicted risk varies with the top feature, illustrating model-behavior explanation for stakeholders.
