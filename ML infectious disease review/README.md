...
A comprehensive AI/ML epidemiology project focused on **ML infectious disease review**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** ML infectious disease review  
...
## Objectives
- Build a clear and reproducible analysis workflow for ML infectious disease review.
...
- **Left panel:** an illustrative comparison of accuracy and F1-score across commonly reviewed ML methods (logistic regression, random forest, XGBoost, SVM, neural network).
- **Right panel:** an illustrative count of reviewed publications by year, showing the kind of literature-trend summary a review workflow would report.
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/391426782_AI_and_Machine_Learning_for_Early_Detection_of_Infectious_Diseases_in_the_US_Opportunities_and_Challenges
2. Add additional peer-reviewed references relevant to ML infectious disease review.
