...
A comprehensive AI/ML epidemiology project focused on **Predicting malaria outbreaks using ML and climate data**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** Predicting malaria outbreaks using ML and climate data  
...
## Objectives
- Build a clear and reproducible analysis workflow for Predicting malaria outbreaks using ML and climate data.
...
- **Left panel:** simulated monthly rainfall alongside malaria case counts (one-month lag) on a dual axis, illustrating a climate-informed forecasting setup.
- **Right panel:** a scatter plot with fitted trend line and correlation coefficient between rainfall and case counts.
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/378298118_Predicting_malaria_prevalence_with_machine_learning_models_using_satellite-based_climate_information
2. Add additional peer-reviewed references relevant to Predicting malaria outbreaks using ML and climate data.
