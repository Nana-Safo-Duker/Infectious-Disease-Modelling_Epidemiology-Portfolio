...
A comprehensive AI/ML epidemiology project focused on **Spatiotemporal epidemic ML**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** Spatiotemporal epidemic ML  
**Primary paper/source:** https://www.researchgate.net/publication/351728407_Machine_learning_spatio-temporal_epidemiological_model_to_evaluate_Germany-county-level_COVID-19_risk

## Objectives
- Build a clear and reproducible analysis workflow for Spatiotemporal epidemic ML.
...
- **Left panel:** simulated case trends for five regions over time, illustrating spatially-distinct epidemic waves.
- **Right panel:** a space-time heatmap of case intensity by region and week, illustrating a spatiotemporal surveillance view.
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/351728407_Machine_learning_spatio-temporal_epidemiological_model_to_evaluate_Germany-county-level_COVID-19_risk
2. Add additional peer-reviewed references relevant to Spatiotemporal epidemic ML.
