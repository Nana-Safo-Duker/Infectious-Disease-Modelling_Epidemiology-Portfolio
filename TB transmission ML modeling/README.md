...
A comprehensive AI/ML epidemiology project focused on **TB transmission ML modeling**. This folder provides reproducible implementations in both Python and R, plus a detailed notebook workflow for exploratory analysis, statistical validation, and transparent reporting.
...
**Research Focus:** TB transmission ML modeling  
**Primary paper/source:** https://www.researchgate.net/publication/377403189_Transmission_Dynamics_of_Tuberculosis_Model_with_Control_Strategies

## Objectives
- Build a clear and reproducible analysis workflow for TB transmission ML modeling.
...
- **Left panel:** simulated transmission compartments (exposed/latent, infectious/active, recovered/treated) over a year, illustrating TB transmission dynamics.
- **Right panel:** simulated relative transmission risk by contact setting (household, healthcare facility, workplace, community, congregate setting).
...
## References
1. Primary paper/source: https://www.researchgate.net/publication/377403189_Transmission_Dynamics_of_Tuberculosis_Model_with_Control_Strategies
2. Add additional peer-reviewed references relevant to TB transmission ML modeling.
